...
(function (nodom) {
    ...
    class DirectiveManager {
        ...
        static exec(directive, dom, module, parent) {
            ...
            //调用
            return nodom.Util.apply(this.directiveTypes.get(directive.type).handler, null, [directive, dom, module, parent]);
        }
    }
    /**
     * 指令类型集合
    ...
    class Element {
        ...
        handleDirectives(module, parent) {
            ...
            for (let i = 0; i < dirs.length && !this.dontRender; i++) {
                nodom.DirectiveManager.exec(dirs[i], me, module, parent);
            }
            return true;
        }
        /**
        ...
        handleProps(module) {
            ...
            nodom.Util.getOwnProps(this.exprProps).forEach((item) => {
                //属性值为数组，则为表达式
                if (nodom.Util.isArray(this.exprProps[item])) {
                    this.props[item] = this.handleExpression(this.exprProps[item], module);
                }
                else if (this.exprProps[item] instanceof nodom.Expression) { //单个表达式
...
/***/ 0:
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** multi ./core/application.ts ./core/compiler.ts ./core/directive.ts ./core/directivefactory.ts ./core/directivemanager.ts ./core/element.ts ./core/expression.ts ./core/expressionfactory.ts ./core/factory.ts ./core/filter.ts ./core/filterfactory.ts ./core/filtermanager.ts ./core/linker.ts ./core/messagequeue.ts ./core/methodfactory.ts ./core/model.ts ./core/modelfactory.ts ./core/module.ts ./core/modulefactory.ts ./core/nodom.ts ./core/nodomerror.ts ./core/nodomevent.ts ./core/renderer.ts ./core/router.ts ./core/scheduler.ts ./core/serializer.ts ./core/util.ts ./core/extend/directiveinit.ts ./core/extend/exposemethod.ts ./core/filterinit.ts ./core/locales/msg_zh.ts ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./core/nodom.ts */"./core/nodom.ts");
...
__webpack_require__(/*! ./core/serializer.ts */"./core/serializer.ts");
__webpack_require__(/*! ./core/util.ts */"./core/util.ts");
__webpack_require__(/*! ./core/extend/directiveinit.ts */"./core/extend/directiveinit.ts");
!(function webpackMissingModule() { var e = new Error("Cannot find module './core/extend/exposemethod.ts'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module './core/filterinit.ts'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
module.exports = __webpack_require__(/*! ./core/locales/msg_zh.ts */"./core/locales/msg_zh.ts");
