...
- database:数据库配置，string|object，可选，用于配置数据库连接和事务信息，noomi将统一管理连接。
...
noomi支持5种connection manager：mysql、oracle、mssql、sequelize、typeorm，用户可以自定义connection manager，自定义connection manager需要加入InstanceFactory。  
